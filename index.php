...
$routes = [
    ...
    '/keypersons/match' => 'routes/keypersons/match.php',
    '/keypersons/assign' => 'routes/keypersons/assign.php',
...
function routePermissionForPath(string $path): string|array|null
{
    $exact = [
        ...
        '/keypersons/match' => 'keypersons.create',
        '/keypersons/assign' => 'keypersons.create',
