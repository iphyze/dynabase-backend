...
{
    return envString('AUTH_COOKIE_NAME', 'dynabase_access_token');
}

function csrfCookieName(): string
{
    return envString('CSRF_COOKIE_NAME', 'dynabase_csrf_token');
}
...
{
    return envString('JWT_ISSUER', 'dynabase-api');
}

function jwtAudience(): string
{
    return envString('JWT_AUDIENCE', 'dynabase-web');
}
...
function invitationTokenHash(string $token): string
{
